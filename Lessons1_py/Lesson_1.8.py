...
# Agar sonlar ketma-ketligi 0 dan boshlansa, range() funktsiyasida yakuniy indeksni ko'rsatish kifoya.
# Misol uchun range(0,10) emas range(10) deb yozsak ham bo'laveradi.
...
# ko'rib turibsizki natijasida 6-7 qo'shilib ikkinchi nusxada paydo bo'lib qoldi
...
# ana endi bu ishladi sababi o'zgarmas ichidagi tuple bilan tupleni ichiga toys ro'xatini kiritdik
# natijada ishladi sinab ko'rishingiz mumkin